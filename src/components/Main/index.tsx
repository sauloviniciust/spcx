const Main = () => {
    ...
    return (
    <section className="flex mt-56 shadow-2xl hover:shadow-green-700 bg-gradient-to-b from-black to-slate-900 flex-col md:flex-col gap-4 lg:items-center lg:justify-center lg:flex-row" id="caminhada">
		
				<img className="lg:w-1/2 shadow-2xl shadow-black rounded-md mx-4 " src="IMG_2295.JPG"  alt="spacechronix tocando na roots" />
		
			<div className="font-lighter lg:w-1/2 text-green-600 mt-4">
				<h3 className="text-2xl lg text-center md:text-3xl lg:mb-3 lg:text-4xl mb-8">Spacechronix/Koan</h3>
				...
				<div className="animate-bounce md:text-3xl lg:text-4xl text-2xl font-lighter hover:text-red-600 text-center mb-10">
