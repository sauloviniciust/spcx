const Main = () => {
    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-9" id="caminhada">
			...
			<div className="font-lighter">
				<h3 className="text-greeen-100 text-2xl md:text-5xl text-center">Spacechronix/Koan</h3>
				<p className="text-greeen-100 text-opacity-80 text-xl md:text-2xl p-5">
				...
				<div className="animate-bounce text-verde-100 md:text-5xl text-2xl font-lighter hover:text-vermelho-100 text-center mb-10">
